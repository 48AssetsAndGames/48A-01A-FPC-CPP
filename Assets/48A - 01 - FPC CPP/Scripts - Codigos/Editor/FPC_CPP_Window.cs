...
public class FPC_CPP_Window : EditorWindow
{
    ...
    private float CampoLayerMask(float y, float ancho, string prop, string labelES, string labelEN, string tipES, string tipEN)
    {
        ...
        EditorGUI.BeginChangeCheck();
        int nuevoMask = EditorGUI.MaskField(rProp, GUIContent.none, p.intValue, UnityEditorInternal.InternalEditorUtility.layers, stMask);
        if (EditorGUI.EndChangeCheck()) p.intValue = nuevoMask;
        return y + KC_H + 3f;
    }
    ...
    private float DibujarContenidoDocumentacion(float ancho)
    {
        ...
        y = BotonLink(y, ancho, ES ? "— ¿Cómo Usar el Asset?" : "How to Use the Asset", ES ? "https://github.com/48AssetsAndGames/48AG-01A-FPC-CPP/blob/main/Assets/48A%20-%2001%20-%20FPC%20CPP/Espa%C3%B1ol/ControladorPrimeraPersona/03___Documentacion/FPC%20CPP_Como%20Usar_V1.0_ES.pdf" : "https://github.com/48AssetsAndGames/48AG-01A-FPC-CPP/blob/main/Assets/48A%20-%2001%20-%20FPC%20CPP/English/FirstPersonController/03___Documentation/FPC%20CPP_How%20To%20Use_V1.0_EN.pdf");
        y = BotonLink(y, ancho, ES ? "— Documentación Técnica" : "Technical Documentation", ES ? "https://github.com/48AssetsAndGames/48AG-01A-FPC-CPP/blob/main/Assets/48A%20-%2001%20-%20FPC%20CPP/Espa%C3%B1ol/ControladorPrimeraPersona/03___Documentacion/FPC%20CPP_Documentaci%C3%B3n%20T%C3%A9cnica_V1.0_ES.pdf" : "https://github.com/48AssetsAndGames/48AG-01A-FPC-CPP/blob/main/Assets/48A%20-%2001%20-%20FPC%20CPP/English/FirstPersonController/03___Documentation/FPC%20CPP_Technical%20Documentation_V1.0_EN.pdf");
